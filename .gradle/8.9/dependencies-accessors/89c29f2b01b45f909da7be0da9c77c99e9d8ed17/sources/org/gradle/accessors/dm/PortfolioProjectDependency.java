...
@NonNullApi
public class PortfolioProjectDependency extends DelegatingProjectDependency {

    @Inject
    public PortfolioProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
